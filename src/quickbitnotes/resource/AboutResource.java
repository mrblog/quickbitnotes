...
public class AboutResource extends BaseResource {
    ...
    private final static Logger logger = Logger.getLogger(AboutResource.class.getName());

    @Get
    public Representation represent() {
        Configuration fmc = (Configuration) getContextAttribute("fmc");

        logger.log(Level.INFO, "Entered AboutResource");
        ...
        logger.log(Level.INFO, "AboutResource page: " + page);

        dataModel.put("thepage", "about_" + page + ".html");
